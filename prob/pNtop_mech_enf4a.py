#
import numpy as np
from prob.util.topo2d_mech import topo2d_init
from prob.util.topo2d_mech import topo2d_simu
#
...
def apar(n):
#   
    mov=5e-2*np.ones(n,dtype=float)
    asf=[0.5,1.5]
#
    enf='none'
#
...
#
    c_x=2e0*np.absolute(df_k)/x_k*0.
    c_x[1:]=0e0
#
...
#
    [c,dc,v,dv,m_x,dm_x,m_y,dm_y]=topo2d_simu(n,m,x,aux,g)
#
    f[0]=c#/360#0
    f[1]=v/n/v_u-1.
    f[2]=m_x/30.-1.
