...
#
    ...
    f_tmp=np.zeros(ndof)
    np.add.at(f_tmp, edofMat[:, :].flatten(), np.kron(xPena(0.,qen,xPhys), gv * \
...
#
    ...
    tmp += 2. * gv * u[edofMat[:,0],0] * -1./8. * dxPena(0.,qen,xPhys)#qen*xPhys**(qen-1.)
    tmp += 2. * gv * u[edofMat[:,1],0] * -1./8. * dxPena(0.,qen,xPhys)#qen*xPhys**(qen-1.)
    tmp += 2. * gv * u[edofMat[:,2],0] * 1./8. * dxPena(0.,qen,xPhys)#qen*xPhys**(qen-1.)
    tmp += 2. * gv * u[edofMat[:,3],0] * -1./8. * dxPena(0.,qen,xPhys)#qen*xPhys**(qen-1.)
    tmp += 2. * gv * u[edofMat[:,4],0] * 1./8. * dxPena(0.,qen,xPhys)#qen*xPhys**(qen-1.)
    tmp += 2. * gv * u[edofMat[:,5],0] * 1./8. * dxPena(0.,qen,xPhys)#qen*xPhys**(qen-1.)
    tmp += 2. * gv * u[edofMat[:,6],0] * -1./8. * dxPena(0.,qen,xPhys)#qen*xPhys**(qen-1.)
    tmp += 2. * gv * u[edofMat[:,7],0] * 1./8. * dxPena(0.,qen,xPhys)#qen*xPhys**(qen-1.)
    dc[:] = tmp
