#
import numpy as np
from prob.util.topo2d_thme import topo2d_init
from prob.util.topo2d_thme import topo2d_simu
#
...
#
    # Set load
    frc=[(2*(nely+1)*int(nelx/2+1)-1,-0.)]
#   frc=[(2*(nely+1)*int(nelx/2+1)-nely-1,-1.)]
#
    pen = 3.#3./9.
    qen = 2.#2./9.
    muc = 0e0
